          ...
          <div className="md:w-1/2 w-full flex flex-col justify-center">
            <div className="mb-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                intervenes swiftly to rescue them and provide immediate support.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                We empower families and communities with sustainable livelihoods
                and awareness programs, ensuring lasting change for generations
                to come.
              </p>
            </div>
            ...
            <div className="flex justify-center md:justify-start">
              <Link
                ...
                className="inline-block bg-blue-600 text-white font-semibold py-3 px-6 rounded-md shadow hover:bg-blue-700 transition duration-300 ease-in-out"
              >
